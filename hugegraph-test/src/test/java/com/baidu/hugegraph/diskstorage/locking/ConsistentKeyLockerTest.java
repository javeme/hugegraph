...
public class ConsistentKeyLockerTest {
    ...
    /**
     * Test that the first {@link com.baidu.hugegraph.diskstorage.PermanentBackendException} thrown by the
     ...
     * fails with a {@link com.baidu.hugegraph.diskstorage.TemporaryBackendException}. The retry should both
     ...
     *
     * @throws InterruptedException shouldn't happen
     * @throws com.baidu.hugegraph.diskstorage.BackendException     shouldn't happen (we expect a TemporaryLockingException but
