...
import com.baidu.hugegraph.core.HugeGraphIndexQuery;
...
import static com.baidu.hugegraph.graphdb.HugeGraphTest.evaluateQuery;
...
public abstract class HugeGraphIndexTest extends HugeGraphBaseTest {
    ...
    /**
     * Tests the {@link com.baidu.hugegraph.example.GraphOfTheGodsFactory#load(com.baidu.hugegraph.core.HugeGraph)}
     * method used as the standard example that ships with HugeGraph.
     */
    @Test
    ...
    public void testSimpleUpdate() {
        ...
        HugeGraphVertex v = tx.addVertex("name", "Marko Rodriguez");
    ...
    public void testInstantIndexing() {
        ...
        v1 = (HugeGraphVertex) graph.vertices(v1.id()).next();
        v1.property("instant", firstTimestamp);
    ...
    public void testConditionalIndexing() {
        ...
        for (int i = 0; i < numV; i++) {
            HugeGraphVertex v = tx.addVertex(i % 2 == 0 ? "person" : "org");
    ...
    private void setupChainGraph(int numV, String[] strs, boolean sameNameMapping) {
        ...
        HugeGraphIndex vindex = getExternalIndex(Vertex.class, INDEX);
        HugeGraphIndex eindex = getExternalIndex(Edge.class, INDEX);
        HugeGraphIndex pindex = getExternalIndex(HugeGraphVertexProperty.class, INDEX);
        PropertyKey name = makeKey("name", String.class);
    ...
    public void testIndexReplay() throws Exception {
        ...
        finishSchema();
        Vertex vs[] = new HugeGraphVertex[4];
...
//        System.out.println(v.getProperty("age"));
    ...
    public void testIndexUpdatesWithoutReindex() throws InterruptedException, ExecutionException {
        ...
        HugeGraphIndex index = mgmt.getGraphIndex("theIndex");
    ...
    private void addVertex(int time, String text, double height, String[] phones) {
        newTx();
        HugeGraphVertex v = tx.addVertex("text", text, "time", time, "height", height);
   ...
   /* ==================================================================================
    ...
    public void testVertexTTLWithMixedIndices() throws Exception {
        ...
        HugeGraphVertex v2 = tx.addVertex("event");
    ...
    public void testEdgeTTLWithMixedIndices() throws Exception {
        ...
        HugeGraphVertex v1 = tx.addVertex(), v2 = tx.addVertex(), v3 = tx.addVertex();
   ...
   /* ==================================================================================
    ...
    public void testIndexQueryWithScore() throws InterruptedException {
        ...
        for (HugeGraphIndexQuery.Result<HugeGraphVertex> r : graph.indexQuery("store1", "v.text:(Hello)").vertices()) {
    ...
    private void testNestedWrites(String initialValue, String updatedValue) throws BackendException {
        ...
        HugeGraphTransaction vertexDeleter = graph.newTransaction();
        HugeGraphTransaction propDeleter = graph.newTransaction();
