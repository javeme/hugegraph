...
import com.baidu.hugegraph.diskstorage.util.TestLockerManager;
...
public abstract class HugeGraphEventualGraphTest extends HugeGraphBaseTest {
    ...
    public void testTimestampSetting() {
        ...
        HugeGraphVertex v1 = tx1.addVertex(name, "a");
        HugeGraphVertex v2 = tx1.addVertex(age, "14", name, "b", age, "42");
        tx1.commit();
