...
import static com.baidu.hugegraph.diskstorage.Backend.EDGESTORE_NAME;
import static com.baidu.hugegraph.diskstorage.Backend.ID_STORE_NAME;
import static com.baidu.hugegraph.diskstorage.Backend.INDEXSTORE_NAME;
import static com.baidu.hugegraph.diskstorage.Backend.LOCK_STORE_SUFFIX;
import static com.baidu.hugegraph.diskstorage.Backend.SYSTEM_MGMT_LOG_NAME;
import static com.baidu.hugegraph.diskstorage.Backend.SYSTEM_TX_LOG_NAME;
import static com.baidu.hugegraph.graphdb.configuration.GraphDatabaseConfiguration.SYSTEM_PROPERTIES_STORE_NAME;
...
public class HBaseStoreManager extends DistributedStoreManager implements KeyColumnValueStoreManager {
    ...
    public HBaseStoreManager(com.baidu.hugegraph.diskstorage.configuration.Configuration config) throws BackendException {
