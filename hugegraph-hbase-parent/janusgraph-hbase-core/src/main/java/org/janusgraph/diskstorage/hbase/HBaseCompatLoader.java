...
public class HBaseCompatLoader {
    ...
    private static final String DEFAULT_HBASE_COMPAT_CLASS_NAME = "org.janusgraph.diskstorage.hbase.HBaseCompat1_0";
    ...
    public synchronized static HBaseCompat getCompat(String classOverride) {
        ...
        if (null != classOverride) {
            ...
            for (String supportedVersion : HBASE_SUPPORTED_VERSIONS) {
                if (hbaseVersion.startsWith(supportedVersion + ".")) {
                    if (hbaseVersion.startsWith(HBASE_VERSION_1_STRING)) {
                        ...
                        className = "org.janusgraph.diskstorage.hbase.HBaseCompat"
            ...
            if (null == className) {
                log.info(
                        "The HBase version {} is not explicitly supported by JanusGraph.  "
