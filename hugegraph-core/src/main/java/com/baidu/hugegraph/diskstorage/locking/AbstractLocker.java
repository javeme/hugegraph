...
import com.baidu.hugegraph.diskstorage.locking.consistentkey.ConsistentKeyLockStatus;
...
public abstract class AbstractLocker<S extends LockStatus> implements Locker {
    ...
    public void checkLocks(StoreTransaction tx) throws TemporaryLockingException, PermanentLockingException {
        ...
        // HugeGraph process is shutting down; for this reason, we return ASAP on an
        // interrupt
        boolean ok = false;
        try {
