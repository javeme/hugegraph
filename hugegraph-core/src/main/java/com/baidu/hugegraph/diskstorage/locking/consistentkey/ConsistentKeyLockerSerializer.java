...
import com.baidu.hugegraph.diskstorage.util.WriteBufferUtil;
...
/**
 * Translate locking coordinates and metadata (data keys, data columns, data values, timestamps, and rids) into keys,
 * columns, and values compatible with {@link ConsistentKeyLocker} and vice-versa.
 */
