...
public interface KeyColumnValueStore {
     ...
     * @throws com.baidu.hugegraph.diskstorage.locking.PermanentLockingException if locking is supported by the implementation and at least
     ...
     * required to, throw {@link com.baidu.hugegraph.diskstorage.locking.PermanentLockingException}.
     ...
     * @throws com.baidu.hugegraph.diskstorage.locking.PermanentLockingException
