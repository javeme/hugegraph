...
public interface StoreFeatures {
    ...
    /**
     * Whether this storage backend preserves key locality. This affects HugeGraph's
     ...
     *
     * This method will be ignored by HugeGraph if {@link #hasTimestamps()} is
     * false.
     *
     ...
     * is provided as a meta-data annotation on the {@link com.baidu.hugegraph.diskstorage.Entry}, the entry will
     * disappear from the storage backend after the given amount of time. See references to
     * {@link com.baidu.hugegraph.diskstorage.EntryMetaData#TTL} for example usage in HugeGraph internals.
     ...
     * by {@link com.baidu.hugegraph.diskstorage.StoreMetaData#TTL}.  This is the coarser-grained of the two
     * TTL modes.
     *
