...
public class EntryArrayList extends ArrayList<Entry> implements EntryList {
    ...
    /**
     * This implementation is an inexact estimate. It's just the product of a constant ({@link #ENTRY_SIZE_ESTIMATE}
     * times the array size. The exact size could be calculated by iterating over the list and summing the remaining
