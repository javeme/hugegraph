 ...
 * <p/>
 * A query is comprised of the store identifier against which the query ought to be executed and a query condition which
 * defines which entries match the query.
 *
...
public class IndexQuery extends BaseQuery implements BackendQuery<IndexQuery> {
    ...
    public boolean equals(Object other) {
        ...
        return store.equals(oth.store) && orders.equals(oth.orders) && condition.equals(oth.condition)
