 ...
 * <p/>
 * An entry consists of a column and value both of which are general {@link java.nio.ByteBuffer}s. The value may be null
 * but the column may not.
 *
...
public interface Entry extends StaticBuffer, MetaAnnotated {
    ...
    /**
     * Sets the cached parsed representation of this Entry. This method does not synchronize, so a previously set
     * representation would simply be overwritten.
     *
     * @param cache
     */
