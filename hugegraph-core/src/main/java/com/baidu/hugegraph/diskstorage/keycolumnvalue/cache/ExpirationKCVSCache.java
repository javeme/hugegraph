...
public class ExpirationKCVSCache extends KCVSCache {
    ...
    public EntryList getSlice(final KeySliceQuery query, final StoreTransaction txh) throws BackendException {
        ...
        try {
            ...
            if (e instanceof HugeGraphException) throw (HugeGraphException)e;
            else if (e.getCause() instanceof HugeGraphException) throw (HugeGraphException)e.getCause();
            else throw new HugeGraphException(e);
        }
    }
