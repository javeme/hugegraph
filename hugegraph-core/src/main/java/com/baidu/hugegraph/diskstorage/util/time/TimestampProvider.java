...
package com.baidu.hugegraph.diskstorage.util.time;
...
public interface TimestampProvider {
    ...
    /**
     * Returns the current time based on this timestamp provider as a {@link Instant}.
     *
     * @return
     */
    ...
    /**
     * Return the units of {@link #getTime()}. This method's return value must be constant over at least the life of the
    ...
    /**
     * Block until the current time as returned by {@link #getTime()} is greater than the given timepoint.
     *
