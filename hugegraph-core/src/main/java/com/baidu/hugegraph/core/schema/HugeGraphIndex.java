...
/**
 * A HugeGraphIndex is an index installed on the graph in order to be able to efficiently retrieve graph elements
 * by their properties.
 * A HugeGraphIndex may either be a composite or mixed index and is created via {@link HugeGraphManagement#buildIndex(String, Class)}.
 * <p/>
