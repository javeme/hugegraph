 ...
 * <ul>
 * <li>Partition: Whether the vertices of this label should be partitioned. A partitioned vertex is split across the
 * partitions in a graph such that each partition contains on "sub-vertex". This allows HugeGraph to effectively manage
...
public interface VertexLabelMaker {
    ...
    /**
     * Enables partitioning for this vertex label. If a vertex label is partitioned, all of its vertices are partitioned
     * across the partitions of the graph.
     *
    ...
    /**
     * Makes this vertex label static, which means that vertices of this label cannot be modified outside of the
