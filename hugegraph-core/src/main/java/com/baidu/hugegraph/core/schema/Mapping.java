...
public enum Mapping {
    ...
    /**
     * Returns the mapping as a parameter so that it can be passed to {@link HugeGraphManagement#addIndexKey(HugeGraphIndex, com.baidu.hugegraph.core.PropertyKey, Parameter[])}
     * @return
     */
