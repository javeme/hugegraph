...
/**
 * RelationTypeMaker is a factory for {@link com.baidu.hugegraph.core.RelationType}s. RelationType can be configured to provide data verification,
 * better storage efficiency, and higher performance. The RelationType defines the schema for all {@link com.baidu.hugegraph.core.HugeGraphRelation}s
 * of that type.
 * <p/>
 * There are two kinds of RelationTypes: {@link com.baidu.hugegraph.core.EdgeLabel} and {@link com.baidu.hugegraph.core.PropertyKey} which
