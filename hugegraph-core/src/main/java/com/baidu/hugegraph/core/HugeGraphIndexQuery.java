 ...
 * query mechanism to exploit the full range of features and functionality of the indexing backend. However, the results
 * returned by this query will not be adjusted to the modifications in a transaction. If there are no changes in a
 * transaction, this won't matter. If there are, the results of this query may not be consistent with the transactional
 * state.
 *
...
public interface HugeGraphIndexQuery {
    ...
    /**
     * Adds the given parameter to the list of parameters of this query. Parameters are passed right through to the
     * indexing backend to modify the query behavior.
     * 
     * @param para
     * @return
     */
    ...
    /**
     * Adds the given parameters to the list of parameters of this query. Parameters are passed right through to the
     * indexing backend to modify the query behavior.
     * 
     * @param paras
     * @return
