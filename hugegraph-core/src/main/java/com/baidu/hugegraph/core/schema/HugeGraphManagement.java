...
public interface HugeGraphManagement extends HugeGraphConfiguration, SchemaManager {
    ...
    public interface IndexBuilder {
         ...
         *
         * @return the created composite {@link HugeGraphIndex}
         */
    ...
    /**
     * Retrieves the consistency modifier for the given {@link HugeGraphSchemaElement}. If none has been explicitly
    ...
    /**
     * Sets the consistency modifier for the given {@link HugeGraphSchemaElement}. Note, that only {@link RelationType}s
     ...
     * @return
     */
    public Duration getTTL(HugeGraphSchemaType type);
     ...
     *
     * @see com.baidu.hugegraph.core.HugeGraphTransaction#commit()
     */
    public void commit();
     ...
     *
     * @see com.baidu.hugegraph.core.HugeGraphTransaction#rollback()
     */
