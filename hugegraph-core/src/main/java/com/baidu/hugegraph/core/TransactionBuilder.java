...
public interface TransactionBuilder {
    ...
    /**
     * Enabling batch loading disables a number of consistency checks inside HugeGraph to speed up the ingestion of
     ...
     * However, if a provided vertex id does not exist in the database and checking is disabled, HugeGraph will assume it
     ...
     * this string will be prepended to all HugeGraph metric names.
     *
     * @param name
