...
public class HugeGraphId {
    ...
    /**
     * Converts a HugeGraph vertex id to the user provided id as the inverse mapping of {@link #toVertexId(long)}.
     *
     * @param id HugeGraph vertex id (must be positive)
     ...
     * @return original user provided id
     */
    public static final long fromVertexID(HugeGraphVertex v) {
