...
/**
 * HugeGraphElement represents the abstract concept of an entity in the graph and specifies basic methods for interacting
 * with entities.
 * The two basic entities in a graph database are {@link HugeGraphRelation} and {@link HugeGraphVertex}.
 * Entities have a life cycle state which reflects the current state of the entity with respect
 * to the {@link HugeGraphTransaction} in which it occurs. An entity may be in any one of these states
 * and any given time:
 * <ul>
...
public interface HugeGraphElement extends Element, Idfiable, Removable {
     ...
     * <p/>
     * HugeGraph allocates blocks of identifiers and automatically assigns identifiers to elements
