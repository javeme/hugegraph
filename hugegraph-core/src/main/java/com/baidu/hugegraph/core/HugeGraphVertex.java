...
/**
 * HugeGraphVertex is the basic unit of a {@link HugeGraph}. It extends the functionality provided by Blueprint's
 * {@link Vertex} by helper and convenience methods.
 * <p />
...
public interface HugeGraphVertex extends HugeGraphElement, Vertex {
     ...
     * and the given vertex being the incoming vertex. <br />
     ...
     * object being the value. <br />
     * Automatically creates the property key if it does not exist and automatic creation of types is enabled.
     * Otherwise, this method with throw an {@link IllegalArgumentException}.
     *
