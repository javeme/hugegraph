...
public interface SchemaInspector {
    ...
    /**
     * Checks whether a property key of the given name has been defined in the HugeGraph schema.
     *
    ...
    /**
     * Checks whether an edge label of the given name has been defined in the HugeGraph schema.
     *
     ...
     * automatically created through the registered {@link com.baidu.hugegraph.core.schema.DefaultSchemaMaker}.
     * <p />
