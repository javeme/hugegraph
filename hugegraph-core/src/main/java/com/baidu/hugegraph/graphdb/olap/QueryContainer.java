...
import com.baidu.hugegraph.graphdb.query.vertex.BaseVertexCentricQuery;
...
public class QueryContainer {
    ...
    public QueryContainer(StandardHugeGraphTx tx) {
    ...
    public HugeGraphTransaction getTransaction() {
        return tx;
    }
...
//        }
        ...
        @Override
        public QueryBuilder has(String key, HugeGraphPredicate predicate, Object value) {
