...
import com.baidu.hugegraph.diskstorage.util.HashingUtil;
...
public class TransactionLogHeader {
    ...
    public StaticBuffer serializeModifications(Serializer serializer, LogTxStatus status, StandardHugeGraphTx tx,
    ...
    private static void logRelations(DataOutput out, final Collection<InternalRelation> relations, StandardHugeGraphTx tx) {
        ...
        for (InternalRelation rel : relations) {
            ...
            com.baidu.hugegraph.diskstorage.Entry entry = tx.getEdgeSerializer().writeRelation(rel, 0, tx);
    ...
    public static class Entry {
        ...
        private static Collection<Modification> readModifications(Change state, ReadBuffer in, Serializer serializer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                com.baidu.hugegraph.diskstorage.Entry entry = BufferUtil.readEntry(in,serializer);
    ...
    public static class Modification {
        ...
        public final com.baidu.hugegraph.diskstorage.Entry relationEntry;

        private Modification(Change state, long outVertexId, com.baidu.hugegraph.diskstorage.Entry relationEntry) {
            this.state = state;
