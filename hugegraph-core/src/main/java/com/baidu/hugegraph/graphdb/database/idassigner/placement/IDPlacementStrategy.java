 ...
 * then assigned to said partition by HugeGraph.
 *
...
public interface IDPlacementStrategy {
    ...
    /**
     * After construction, the {@link com.baidu.hugegraph.graphdb.idmanagement.IDManager} used by this graph instance
    ...
    /**
     * If HugeGraph is embedded, this method is used to indicate to the placement strategy which
     ...
     * faster).
     * <p/>
     * This method can be called at any time while HugeGraph is running. It is typically called right
