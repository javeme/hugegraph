...
import com.baidu.hugegraph.core.BaseVertexQuery;
import com.baidu.hugegraph.core.HugeGraphElement;
import com.baidu.hugegraph.core.HugeGraphMultiVertexQuery;
...
public class HugeGraphVertexStep<E extends Element> extends VertexStep<E> implements HasStepFolder<Vertex, E>, Profiling, MultiQueriable<Vertex,E> {
    ...
    private Map<HugeGraphVertex, Iterable<? extends HugeGraphElement>> multiQueryResults = null;
    ...
    @Override
    public HugeGraphVertexStep<E> clone() {
        final HugeGraphVertexStep<E> clone = (HugeGraphVertexStep<E>) super.clone();
