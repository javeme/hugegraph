...
public class QueryUtil {
    ...
    public static Iterable<HugeGraphVertex> getVertices(StandardHugeGraphTx tx,
    ...
    public static Iterable<HugeGraphEdge> getEdges(StandardHugeGraphTx tx,
                                                    PropertyKey key, Object equalityCondition) {
    ...
    /**
     * Query-normal-form (QNF) for HugeGraph is a variant of CNF (conjunctive normal form) with negation inlined where possible
     *
     * @param condition
     * @return
     */
     ...
     */
    public static <E extends HugeGraphElement> And<E> constraints2QNF(StandardHugeGraphTx tx, List<PredicateCondition<String, E>> constraints) {
        ...
        for (PredicateCondition<String, E> atom : constraints) {
            ...
            if (type.isPropertyKey()) {
                ...
                Preconditions.checkArgument(predicate.isValidValueType(HugeGraphVertex.class), "Data type of key is not compatible with condition");
            }
