...
public class IndexHelper {
    public static Iterable<? extends Element> getQueryResults(CompositeIndexType index, Object[] values,
    ...
    public static GraphCentricQueryBuilder getQuery(CompositeIndexType index, Object[] values, StandardHugeGraphTx tx) {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            Preconditions.checkArgument(key.dataType().equals(value.getClass()),
                    "Incompatible data types for: " + value);
