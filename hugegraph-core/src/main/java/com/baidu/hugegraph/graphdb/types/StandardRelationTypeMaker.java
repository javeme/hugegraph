...
public abstract class StandardRelationTypeMaker implements RelationTypeMaker {
    ...
    public StandardRelationTypeMaker(final StandardHugeGraphTx tx, String name,
     ...
     * time interval using {@link com.baidu.hugegraph.core.HugeGraphVertexQuery#interval(com.baidu.hugegraph.core.PropertyKey, Comparable, Comparable)}.
     * <br />
     ...
     * in the given order.
     * <p/>
     * {@link com.baidu.hugegraph.core.RelationType}s used in the sort key must be either property out-unique keys or out-unique unidirected edge lables.
     *
    ...
    /**
     * Defines in which order to sort the relations for efficient retrieval, i.e. either increasing ({@link com.baidu.hugegraph.graphdb.internal.Order#ASC}) or
     * decreasing ({@link com.baidu.hugegraph.graphdb.internal.Order#DESC}).
     *
