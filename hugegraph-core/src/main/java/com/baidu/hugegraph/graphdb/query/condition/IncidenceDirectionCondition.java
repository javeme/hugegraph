...
public class IncidenceDirectionCondition<E extends HugeGraphRelation> extends Literal<E> {
    ...
    public IncidenceDirectionCondition(Direction direction, HugeGraphVertex otherVertex) {
    ...
    public boolean evaluate(E relation) {
        return relation.isEdge() && ((HugeGraphEdge) relation).vertex(direction).equals(otherVertex);
    }
