...
import com.baidu.hugegraph.core.HugeGraphProperty;
...
public class SimpleHugeGraphProperty<V> implements HugeGraphProperty<V> {
    ...
    public SimpleHugeGraphProperty(InternalRelation relation, PropertyKey key, V value) {
        this.key = key;
        this.value = value;
    ...
    @Override
    public HugeGraphElement element() {
        return relation;
    }
