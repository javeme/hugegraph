...
public abstract class IndexUpdateJob {
    ...
    public static ConfigNamespace INDEX_JOB_NS = new ConfigNamespace(GraphDatabaseConfiguration.JOB_NS, "index",
            "Configuration options relating to index jobs");
    ...
    public static final ConfigOption<String> INDEX_RELATION_TYPE =
            new ConfigOption<String>(INDEX_JOB_NS, "relation-type",
    ...
    protected StandardHugeGraph graph;
    protected ManagementSystem mgmt = null;
    protected StandardHugeGraphTx writeTx;
    ...
    public void workerIterationStart(HugeGraph graph, Configuration config, ScanMetrics metrics) {
        ...
        try {
            ...
            writeTx = (StandardHugeGraphTx) txb.start();
