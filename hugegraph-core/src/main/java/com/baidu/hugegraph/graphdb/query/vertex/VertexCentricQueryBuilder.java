...
/**
 * Implementation of {@link HugeGraphVertexQuery} that extends {@link BasicVertexCentricQueryBuilder}
 * for all the query building and optimization and adds only the execution logic in
 * {@link #constructQuery(com.baidu.hugegraph.graphdb.internal.RelationCategory)}. However, there is
 * one important special case: If the constructed query is simple (i.e. {@link com.baidu.hugegraph.graphdb.query.vertex.VertexCentricQuery#isSimple()=true}
 ...
 */
public class VertexCentricQueryBuilder extends BasicVertexCentricQueryBuilder<VertexCentricQueryBuilder> implements HugeGraphVertexQuery<VertexCentricQueryBuilder> {
