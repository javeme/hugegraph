...
import com.baidu.hugegraph.diskstorage.ResourceUnavailableException;
...
public class ManagementLogger implements MessageReader {
    ...
    private class SendAckOnTxClose implements Runnable {
        ...
        private final Set<? extends HugeGraphTransaction> openTx;
        private final String originId;

        private SendAckOnTxClose(long evictionId, String originId, Set<? extends HugeGraphTransaction> openTx) {
            this.evictionId = evictionId;
            this.openTx = openTx;
        ...
        public void run() {
            ...
            while (true) {
                ...
                Iterator<? extends HugeGraphTransaction> iter = openTx.iterator();
                while (iter.hasNext()) {
