...
public class GraphCentricQueryBuilder implements HugeGraphQuery<GraphCentricQueryBuilder> {
     ...
     */
    private List<PredicateCondition<String, HugeGraphElement>> constraints;
    /**
    ...
    public GraphCentricQueryBuilder(StandardHugeGraphTx tx, IndexSerializer serializer) {
    ...
    @Override
    public GraphCentricQueryBuilder has(String key, HugeGraphPredicate predicate, Object condition) {
        Preconditions.checkNotNull(key);
        Preconditions.checkNotNull(predicate);
        Preconditions.checkArgument(predicate.isValidCondition(condition), "Invalid condition: %s", condition);
        constraints.add(new PredicateCondition<String, HugeGraphElement>(key, predicate, condition));
        return this;
    }
