...
/**
 * Copied from org.apache.tinkerpop.gremlin.process.traversal.util.ScriptTraversal
 * ScriptTraversal force last statement of script be traversal and it is defined
 * as final class.
 */
