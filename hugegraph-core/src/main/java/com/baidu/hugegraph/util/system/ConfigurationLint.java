...
public class ConfigurationLint {
    ...
    public static void main(String args[]) throws IOException {
        if (1 != args.length) {
            System.err.println("Usage: ConfigurationLint hugegraph.properties");
    ...
    public static Status validate(String filename) throws IOException {
        ...
        while (iter.hasNext()) {
            ...
            try {
                ...
                // ConfigElement shouldn't return null; failure here probably relates to hugegraph-core, not the file
