...
import com.baidu.hugegraph.hadoop.formats.util.input.HugeGraphHadoopSetup;
...
import static com.baidu.hugegraph.hadoop.formats.util.input.HugeGraphHadoopSetupCommon.SETUP_CLASS_NAME;
import static com.baidu.hugegraph.hadoop.formats.util.input.HugeGraphHadoopSetupCommon.SETUP_PACKAGE_PREFIX;
...
public abstract class GiraphInputFormat extends InputFormat<NullWritable, VertexWritable> implements Configurable {
    ...
    private static final RefCountedCloseable<HugeGraphVertexDeserializer> refCounter;

    static {
        refCounter = new RefCountedCloseable<>((conf) -> {
            final String hugegraphVersion = "current";
