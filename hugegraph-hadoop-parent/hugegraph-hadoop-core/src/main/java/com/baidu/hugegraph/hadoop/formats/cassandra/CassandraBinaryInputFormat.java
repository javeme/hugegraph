...
package com.baidu.hugegraph.hadoop.formats.cassandra;
...
public class CassandraBinaryInputFormat extends AbstractBinaryInputFormat {
    ...
    public void setConf(final Configuration config) {
        ...
        if (hugegraphConf.has(GraphDatabaseConfiguration.AUTH_PASSWORD))
            ConfigHelper.setInputKeyspacePassword(config, hugegraphConf.get(GraphDatabaseConfiguration.AUTH_PASSWORD));
