...
public abstract class AbstractIndexManagementIT extends HugeGraphBaseTest {
    ...
    public void testRemoveGraphIndex() throws InterruptedException, BackendException, ExecutionException {
        ...
        HugeGraphManagement m = graph.openManagement();
        HugeGraphIndex nameIndex = m.getGraphIndex("name");
        ...
        HugeGraphIndex index = m.getGraphIndex("name");
    ...
    public void testRepairGraphIndex() throws InterruptedException, BackendException, ExecutionException {
        ...
        // Test the index
        Iterable<HugeGraphVertex> hits = graph.query().has("age", 4500).vertices();
        assertNotNull(hits);
        assertEquals(1, Iterables.size(hits));
        HugeGraphVertex v = Iterables.getOnlyElement(hits);
        assertNotNull(v);
