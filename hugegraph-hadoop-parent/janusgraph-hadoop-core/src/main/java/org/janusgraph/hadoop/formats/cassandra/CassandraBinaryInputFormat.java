...
public class CassandraBinaryInputFormat extends AbstractBinaryInputFormat {
    ...
    public RecordReader<StaticBuffer, Iterable<Entry>> createRecordReader(final InputSplit inputSplit,
        ...
        janusgraphRecordReader = new CassandraBinaryRecordReader(columnFamilyRecordReader);
        return janusgraphRecordReader;
    }
    ...
    public void setConf(final Configuration config) {
        ...
        // Copy some JanusGraph configuration keys to the Hadoop Configuration keys used by Cassandra's
        ...
        predicate.setSlice_range(getSliceRange(JanusGraphHadoopSetupCommon.DEFAULT_SLICE_QUERY, rangeBatchSize)); // TODO
                                                                                                                  // stop
                                                                                                                  // slicing
                                                                                                                  // the
                                                                                                                  // whole
