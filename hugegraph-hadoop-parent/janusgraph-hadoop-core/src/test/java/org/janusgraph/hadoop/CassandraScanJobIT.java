...
public class CassandraScanJobIT extends JanusGraphBaseTest {
    ...
    public void testPartitionedVertexScan() throws Exception {
        ...
        c.set(ConfigElement.getPath(JanusGraphHadoopConfiguration.GRAPH_CONFIG_KEYS, true) + "."
                + "storage.cassandra.keyspace", getClass().getSimpleName());
        c.set(ConfigElement.getPath(JanusGraphHadoopConfiguration.GRAPH_CONFIG_KEYS, true) + "." + "storage.backend",
                "cassandrathrift");
