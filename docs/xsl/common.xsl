<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
  ...
  <xsl:param name="hugegraph.top.nav.links" select="0" />

  <!-- hugegraph-themed output templates -->
  <xsl:template name="hugegraph.head">
    ...
    <link rel='stylesheet' id='inline-blob-from-avada-prototype-hugegraph-docs-specific' href='css/docs.css' type='text/css' media='all' />
  ...
  <xsl:template name="hugegraph.header.navigation">
        ...
        <header id="header">
          <div class="avada-row" style="margin-top:0px;margin-bottom:0px;">
            <div class="logo" style="margin-right:0px;margin-top:31px;margin-left:0px;margin-bottom:31px;">
              <a href="http://hugegraph.org">
                <img src="avada-stub/images/hugegraph-logo.png" alt="hugegraph" class="normal_logo" />
              </a>
            </div>
            <nav id="nav" class="nav-holder">
              <ul class="navigation menu fusion-navbar-nav">
                ...
                <li id="menu-item-4712" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4712"><a href="https://github.com/hugegraph/hugegraph/releases">Other Versions</a></li>
                <li id="menu-item-4710" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4710"><a href="https://github.com/hugegraph/hugegraph/releases">Download hugegraph</a></li>
              </ul>
            </nav>
    ...
    <header id="header-sticky" class="sticky-header">
      <div class="sticky-shadow">
        <div class="avada-row">
          <div class="logo">
            <a href="http://hugegraph.org">
              <img src="avada-stub/images/hugegraph-logo.png" alt="hugegraph" data-max-width="" class="normal_logo" />
            </a>
          </div>
  ...
  <xsl:template name="hugegraph.body">
    <xsl:param name="prev"/>
    <xsl:param name="next"/>
	...
	<footer id="footer">
	  <div class="avada-row">
	    <ul class="copyright">
	      <li>
              Copyright © 2017 hugegraph Authors. All rights reserved.<br />
